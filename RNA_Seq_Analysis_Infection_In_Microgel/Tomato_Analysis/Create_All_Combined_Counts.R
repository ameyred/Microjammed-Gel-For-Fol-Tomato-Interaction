#Written on 13th June to plot PCA for Microgel paper (tomato side)
...
tx2gene_path <- "~/Amey_Lab/Microgel_Project/Big_Experiment/Tomato_Analysis/Transcript_To_Gene.csv"
...
quant_dir <- "~/Amey_Lab/Microgel_Project/Big_Experiment/Tomato_Analysis/All_Quant_SF_Files"
...
output_file <- "~/Amey_Lab/Microgel_Project/Big_Experiment/Tomato_Analysis/All_Combined_Counts.csv"
