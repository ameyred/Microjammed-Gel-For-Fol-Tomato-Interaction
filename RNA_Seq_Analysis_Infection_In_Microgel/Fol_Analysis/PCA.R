# This script was updated on 12th June, 2025

library(ggplot2)

# Load and prepare count matrix
count_matrix <- read.csv("~/Amey_Lab/Microgel_Project/Big_Experiment/Fol_Analysis/All_Combined_Counts.csv", row.names = 1)
...
condition <- factor(sub("_[0-9]+$", "", samples), levels = c(
  "Distal_Fungus", "Fungus", "Fungus_Near_Root", "Infected_Root", "Infected_Tip"
))
...
fill_colors <- c(
  "Distal_Fungus" = rgb(194, 106, 119, maxColorValue = 255),
  "Fungus" = rgb(46, 37, 133, maxColorValue = 255),
  "Fungus_Near_Root" = rgb(51, 117, 56, maxColorValue = 255),
  "Infected_Root" = rgb(220, 205, 125, maxColorValue = 255),
  "Infected_Tip" = rgb(126, 41, 84, maxColorValue = 255)
)
